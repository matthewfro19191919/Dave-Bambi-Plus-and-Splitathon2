...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'eevee':
				...
				setGraphicSize(Std.int((width * 3.5) / furiosityScale));
			case 'bf-3d':
				frames = Paths.getSparrowAtlas('characters/bf/3d_bf', 'shared');
			...
			case 'boss':
				...
				animation.addByPrefix('singRIGHT', 'The Boss Sing note RIGHT0', 24, false);
	...
	{
		var offsetStuffs:Array<String> = CoolUtil.coolframestFile(Paths.offsetFile(character));
